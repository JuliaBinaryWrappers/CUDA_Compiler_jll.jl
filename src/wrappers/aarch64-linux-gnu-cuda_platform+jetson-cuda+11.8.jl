# Autogenerated wrapper script for CUDA_Compiler_jll for aarch64-linux-gnu-cuda_platform+jetson-cuda+11.8
...
JLLWrappers.@declare_library_product(libnvrtc_builtins, "libnvrtc-builtins.so.11.8")
