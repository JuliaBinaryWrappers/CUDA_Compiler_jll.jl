# Autogenerated wrapper script for CUDA_Compiler_jll for aarch64-linux-gnu-cuda_platform+jetson-cuda+12
export libcudadevrt, libdevice, libnvvm, nvdisasm, nvlink, ptxas
